...
function changeDIV(id){
	if(id == "1"){
		$_ID('title01').className = "maintitletd1";
		$_ID('title02').className = "maintitletda font01";
		$_ID('title03').className = "maintitletdb font01";
		$_ID('title04').className = "maintitletda font01";
		$_ID('title05').className = "maintitletd font01";
	}else if(id == "2"){
		$_ID('title01').className = "maintitletd font01";
		$_ID('title02').className = "maintitletda1";
		$_ID('title03').className = "maintitletdb font01";
		$_ID('title04').className = "maintitletda font01";
		$_ID('title05').className = "maintitletd font01";
	}else if(id == "3"){
		$_ID('title01').className = "maintitletd font01";
		$_ID('title02').className = "maintitletda font01";
		$_ID('title03').className = "maintitletdb1";
		$_ID('title04').className = "maintitletda font01";
		$_ID('title05').className = "maintitletd font01";
	}else if(id == "4"){
		$_ID('title01').className = "maintitletd font01";
		$_ID('title02').className = "maintitletda font01";
		$_ID('title03').className = "maintitletdb font01";
		$_ID('title04').className = "maintitletda1";
		$_ID('title05').className = "maintitletd font01";
	}else if(id == "5"){
		$_ID('title01').className = "maintitletd font01";
		$_ID('title02').className = "maintitletda font01";
		$_ID('title03').className = "maintitletdb font01";
		$_ID('title04').className = "maintitletda font01";
		$_ID('title05').className = "maintitletd1";
	}
	for(var i = 1; i < 6; i++){
		if($_ID('calculate0' + i) != null){
			$_ID('calculate0' + i).style.display = "none";
		}
		if($_ID('note0' + i) != null){
			$_ID('note0' + i).style.display = "none";
		}
	}
	$_ID('calculate0' + id).style.display = "block";
	$_ID('note0' + id).style.display = "block";
}
...
lilv_array[20][1][10] = 0.0590;//商贷 5-30年 7.05%
...
lilv_array[23][1][5] = 0.0590;//商贷 1～5年 7.59%
lilv_array[23][1][10] = 0.07955;//商贷 5-30年 7.755%
...
lilv_array[24][1][5] = 0.0525;//商贷 1～5年 5.25%
lilv_array[24][1][10] = 0.054;//商贷 5-30年 5.4%
lilv_array[24][2][5] = 0.03;//公积金 1～5年 3%
lilv_array[24][2][10] = 0.035;//公积金 5-30年 3.5%
//15年6月28日利率下限（7折）
lilv_array[25] = new Array;
lilv_array[25][1] = new Array;
lilv_array[25][2] = new Array;
lilv_array[25][1][5] = 0.0339;//商贷 1～5年 3.39%
lilv_array[25][1][10] = 0.0378;//商贷 5-30年 3.78%
lilv_array[25][2][5] = 0.03;//公积金 1～5年 3%
lilv_array[25][2][10] = 0.035;//公积金 5-30年 3.5%
//15年6月28日利率下限（85折）
lilv_array[26] = new Array;
lilv_array[26][1] = new Array;
lilv_array[26][2] = new Array;
lilv_array[26][1][5] = 0.0412;//商贷 1～5年 4.12%
lilv_array[26][1][10] = 0.0459;//商贷 5-30年 4.59%
lilv_array[26][2][5] = 0.03;//公积金 1～5年 3%
lilv_array[26][2][10] = 0.035;//公积金 5-30年 3.5%
//15年6月28日利率下限（1.1倍）
lilv_array[27] = new Array;
lilv_array[27][1] = new Array;
lilv_array[27][2] = new Array;
lilv_array[27][1][5] = 0.0578;//商贷 1～5年 5.78%
lilv_array[27][1][10] = 0.0594;//商贷 5-30年 5.94%
lilv_array[27][2][5] = 0.03;//公积金 1～5年 3%
lilv_array[27][2][10] = 0.035;//公积金 5-30年 3.5%
...
function ShowLilv(month, lt){
	...
	$_ID("sdlv").innerHTML = myround(lilv_array[lt][1][year] * 100, 2) + "%";
	$_ID("gjlv").innerHTML = myround(lilv_array[lt][2][year] * 100, 2) + "%";
}
...
function chanage_type_mm(){
	if($_ID("dengeben2").checked)
		$_ID("type1_mm1").innerHTML = '&nbsp;&nbsp;月均金额：<textarea name="month_money1" rows="5" ></textarea>';
	else
		$_ID("type1_mm1").innerHTML = '&nbsp;&nbsp;月均还款：<input name="month_money1" type="text" class="guestbook02" />元';
}
...
function pl(){
	...
	XmlHttp.open("POST", "/house/newhouse/newhouse_calculateTool_projList.aspx?price=" + Math.round(document.myform.rg08.value), false);
	XmlHttp.send(null);
	if(XmlHttp.status == 200){
		$_ID('projList').innerHTML = XmlHttp.responseText;
	}
}